...
export const getLastMessages = async ({ chat_id, bot_id, number_of_messages, min_date }: QueryLastMessages) => {
...
export const saveCompletion = async (gptResponse: GptValidResponse, message: Message, bot: Bot) => {
